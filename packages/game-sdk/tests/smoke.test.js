...
import { gameSdkScaffold } from "../src/index.ts";

const packageJson = JSON.parse(
  readFileSync(new URL("../package.json", import.meta.url), "utf8")
);

describe("game sdk bootstrap", () => {
  ...
  it("exports scaffold metadata", () => {
    expect(gameSdkScaffold.workspace).toBe("game-sdk");
    expect(gameSdkScaffold.purpose).toMatch(/runtime contract/i);
  });
});
