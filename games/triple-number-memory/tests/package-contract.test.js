...
describe("triple-number-memory package contract", () => {
  it("ships a valid manifest and referenced assets", () => {
    ...
    expect(parsedManifest.gameId).toBe("triple-number-memory");
    expect(parsedManifest.slug).toBe("triple-number-memory");
